...
//    setTriangle(7, 35, 34, 33);
    ...
    setQuad(4, 12, 14, 15, 13);
    setQuad(5, 15, 17, 18, 16);
    setQuad(6, 17, 19, 20, 18);
    setQuad(7, 19, 21, 23, 22);


    setQuad(8, 0, 1, 13, 12);
    setQuad(9, 0, 2, 14, 12);
    setQuad(10, 2, 3, 15, 14);
    setQuad(11, 3, 5, 17, 15);
    setQuad(12, 5, 7, 19, 17);
    setQuad(13, 7, 9, 21, 19);

    setQuad(14, 9, 11, 23, 21);
    setQuad(15, 11, 10, 22, 23);
    setQuad(16, 10, 8, 20, 22);
    setQuad(17, 8, 6, 18, 20);
    setQuad(18, 6, 4, 16, 18);
    setQuad(19, 4, 1, 13, 16);
